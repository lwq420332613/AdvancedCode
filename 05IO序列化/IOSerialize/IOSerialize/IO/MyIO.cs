...
namespace IOSerialize.IO
{
    ...
    public class MyIO
    {
        ...
        public static void GetChildDirectory(List<DirectoryInfo> directoryList,DirectoryInfo directoryParent)
        {
            DirectoryInfo[] childList = directoryParent.GetDirectories();
            if (childList.Length >0)
            {
                directoryList.AddRange(childList);
